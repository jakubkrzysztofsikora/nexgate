...
It is off until you opt in, and the opt-in is a single variable — it both
renders the `bielik` route into the catalog and tells the launcher it may run.
While the value is still the placeholder, neither happens:
